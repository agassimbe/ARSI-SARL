...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210410_arsi_02fc5f0e0ff02d842858_20210410094320_archive.zip';
	const ARCHIVE_SIZE		 = '52433888';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '02fc5f0-10094320';
    const SECONDARY_PACKAGE_HASH = '46ff98d-10094320';
	const VERSION			 = '1.4.0';
